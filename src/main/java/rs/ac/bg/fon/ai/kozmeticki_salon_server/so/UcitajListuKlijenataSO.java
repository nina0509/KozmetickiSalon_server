...
import rs.ac.bg.fon.ai.kozmeticki_salon_zajednicki.domen.Klijent;
 ...
 /**
 * Klasa koja predstavlja sistemsku operaciju za učitavanje liste svih klijenata iz baze.
...
public class UcitajListuKlijenataSO extends OpstaSO {
     ...
     * 
     * @param param Objekat koji predstavlja klijenta za učitavanje(u ovom slucaju je null jer ucitavamo sve klijente).
