...
/**
 * Klasa koja predstavlja sistemsku operaciju za učitavanje liste svih usluga iz
 * baze. Ova klasa nasleđuje klasu OpstaSO i implementira njene metode za
...
public class UcitajListuUslugaSO extends OpstaSO {
     ...
     *
     * @param param Objekat koji predstavlja uslugu za učitavanje(u ovom slucaju
     * je null jer ucitavamo sve usluge).
     ...
     *
     * @param Usluge Nove ucitane usluge.
     */
