...
/**
 * Klasa koja predstavlja sistemsku operaciju za učitavanje liste svih
 * statistika iz baze. Ova klasa nasleđuje klasu OpstaSO i implementira njene
...
public class UcitajListuStatistikaSO extends OpstaSO {
    ...
    /**
     * Izvršava operaciju učitavanja liste svih statistika iz baze podataka kao
     * i njihovih stavki.
     *
     * @param param Objekat koji predstavlja statistiku za učitavanje(u ovom
     * slucaju je null jer ucitavamo sve statistike).
